...
* */
    ...
    // 生成签名时所使用的秘钥
    private static final String SECRET_KEY = "www.612ch.cn";


    private static final String TOKEN_SECRET = Base64.encodeBase64String(SECRET_KEY.getBytes());
     ...
     * @return 加密的token
     */
    public static String signByUserName(String userName) {
        return signByUser(userName, null, DEFAULT_EXPIRE_TIME);
    }
    ...
    public static String signByUser(String userName, Integer userId) {
        return signByUser(userName, userId.toString(), DEFAULT_EXPIRE_TIME);
    }
    ...
    public static void main(String[] args) {
        String admin = signByUser("demon", "123456");
        Map map = new HashMap();
        map.put("username", "demon");
        String signmap = signByMap(map);
